...
IPlayer::HAND GetRandomHand()
{
   ...
   typedef std::tr1::variate_generator<std::tr1::mt19937&,
                                       std::tr1::uniform_int<unsigned long>> UniformReal6419937;
   static std::tr1::uniform_int<unsigned long> distr(0, 2);
   static std::tr1::mt19937 mt19937(static_cast<unsigned long>(time(0)));
